...
public class ConfigManager extends JavaPlugin {
    ...
    public void saveCustomConfig() {
        try {
            ...
            Bukkit.getServer().getConsoleSender().sendMessage("The " + FileName + " file has been saved.");
        } catch (IOException e) {
            Bukkit.getServer().getConsoleSender().sendMessage("Could not save the " + FileName + " file.");
        }
    }
